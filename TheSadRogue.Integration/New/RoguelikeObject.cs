...
{
    /// <summary>
    /// Class that implements IGameObject and uses a SadConsole entity to represent objects on a map.
    /// </summary>
    [PublicAPI]
    public class RoguelikeObject : Entity, IGameObject
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        public RoguelikeObject(ColoredGlyph appearance, Point position, int layer, bool isWalkable = true, bool isTransparent = true,
